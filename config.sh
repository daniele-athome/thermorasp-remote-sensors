...
# Your main sketch
ARDUINO_SKETCH_FILE="remote-http-sensors.ino"
ARDUINO_SKETCH="$PWD/remote-http-sensors/$ARDUINO_SKETCH_FILE"

################################################################################
# ARDUINO - Configure Arduino binairy and options
################################################################################
ARDUINO_BIN=$ARDUINO_HOME/arduino                   # Arduino binairy location
